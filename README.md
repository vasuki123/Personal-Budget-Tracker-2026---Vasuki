...
- 314 dynamic formulas (zero errors)
- 4 auto-calculating charts
- 25 customizable budget categories
- Spending analysis with actionable recommendations
- Month-over-month change tracking with color-coded verdicts
- Sample data included (Jan-Mar) so you can see it working instantly
- Works in Microsoft Excel and Google Sheets
- No macros, no VBA, no complicated setup
- One file, completely offline, yours forever
...
- Microsoft Excel (Advanced Formulas, Conditional Formatting, Charts, INDEX/MATCH, LARGE, IFERROR)
...
- Portfolio: [vasuki123.github.io/vasuki-s-portfolio](https://vasuki123.github.io/vasuki-s-portfolio)
- LinkedIn: [linkedin.com/in/vasuki-balasubramanian31](https://linkedin.com/in/vasuki-balasubramanian31)
